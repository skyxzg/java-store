 ...
 * 
 * @author lixj 2012-11-28 下午4:11:54
 */
public class DBPasswordUtil {
    private static final byte[] KEY_DATA = "aliyun_db_secret_key".getBytes();
    ...
    public static void main(String[] args) throws NamingException, InvalidKeyException, NoSuchAlgorithmException,
            ...
            DecoderException {
        String secretText = encode("polardb_phoenix_center");
        System.out.println("encode:phoenix->" + secretText);
        System.out.println("decode:" + secretText + "->" + decode(secretText));
        
        String secretText2 = encode("root");
        System.out.println("encode:root->" + secretText2);
        System.out.println("decode:" + secretText2 + "->" + decode(secretText2));
    }
